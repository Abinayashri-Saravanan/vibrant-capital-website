...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Four Waves Framework - Full Viewport Section */}
      <section className="min-h-screen flex items-center py-20">
        <div className="container mx-auto px-6 w-full">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-16 text-foreground uppercase tracking-wider">
            ...
            <p className="mt-12 text-center text-lg md:text-xl font-bold text-foreground">
      ...
      {/* Investment Approach - Full Viewport Section */}
      <section className="min-h-screen flex items-center py-20">
        <div className="container mx-auto px-6 w-full">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-16 text-foreground uppercase tracking-wider">
      ...
      {/* Call to Action - Full Viewport Section */}
      <section className="min-h-screen flex items-center section-spacex">
        <div className="container mx-auto px-6 w-full">
          <div className="max-w-4xl mx-auto text-center">
