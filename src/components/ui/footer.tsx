      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-primary-foreground">Vibrant Capital</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Link to="/investments" className="block text-primary-foreground/80 hover:text-primary-foreground transition-colors text-sm">
                Investments
              </Link>
              <Link to="/sectors" className="block text-primary-foreground/80 hover:text-primary-foreground transition-colors text-sm">
                Sectors
              </Link>
            </div>
          </div>
          ...
          {/* Services */}
          <div className="space-y-4">
            <h4 className="font-semibold text-primary-foreground">Services</h4>
            <div className="space-y-2">
              <Link to="/for-investors" className="block text-primary-foreground/80 hover:text-primary-foreground transition-colors text-sm">
                For Investors
              </Link>
